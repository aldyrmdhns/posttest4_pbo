...
public class Main {
    ...
    static ArrayList<Hero> dataHero = new ArrayList<>(){
        {
            add(new Hero("Kamisato Ayaka", "Frostlake Heron", "Cryo", "Kamisato CLan", "Inazuma", 342.03, 12858, 783.93, 150,25.30, 180.0));
            add(new Hero("Ningguang", "Eclipsing Star", "Geo", "Liyue Qixing", "Liyue", 212.4, 9787, 573.32, 50,79.3, 150.0));
            add(new Hero("Jean", "Dandelion Knight", "Anemo", "Favonious Knight", "Mondstat", 239.18, 14695, 768.55, 300,55.0, 80.0));
        }
    };
    ...
    static void isAddChar() throws NumberFormatException, IOException{
        ...
        if (choose == 1) {
            ...
            if (isInArray) {
                Hero addHero = new Hero(heroName, heroTitle, heroElement, heroAssociation, heroRegion, heroAttack, heroHP, heroDeff, heroEM, heroCr, heroCd);
